...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def refresh(self):
        #wc = WebClient("http://139.59.150.2:8000")
    ...
    def startWork(self):
        ...
        cancelButton.clicked.connect(self.completedHandler)
    ...
    def changeElementInDialog(self, orderId, bundleId, element):
        ...
        self.a = QtWidgets.QDialog()

        self.a.setWindowTitle("helpDialog")

        cancelButton = QtWidgets.QPushButton("Cancel",self.a)
        cancelButton.clicked.connect(self.a.close)

        layout = QtWidgets.QVBoxLayout(self.a)
    ...
    def goodHandler(self, goodCode):

        if goodCode == Machine.ACHTUNG_GONE:
            self.achtungDialog.close()

        elif goodCode == Machine.NEW_SLIDE:
